// Shows the difference between each of a list of golf socres and their average.
#include <iostream>
const int MAX_NUMBER_SCORES = 10;

void fill_array(int a[], int size, int& number_used);
// Precondition: size is the declared size of the array a.
// Postcondition: number_used is the number of values stored in a. a[0] through a[number_used - 1] have been filled with nonnegative integers read from the keyboard.

double compute_average(const int a[], int number_used);
// Precondition: a[0] through a[number_used - 1] have vales; numbe_used > 0.
...
// Postcondition: Gives screen output showing how much each of the first number_used elements of a differs from their average.
